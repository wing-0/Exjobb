...
%	which is equation (2) in \cite{Gurvich1987}.
	...
	\begin{figure}[h]
		...
		\begin{tikzpicture}
			...
			\draw[shift = {(-5,0)}] (0,-0.5) node{EM tx} (0,0) -- (0.2,0) -- (0.4,0.15)
			(0.2,0) -- (0.4,-0.15);
			...
			\draw[shift = {(210:5)}, rotate = 30] (0,-0.5) node{AO tx} (0,0) -- (0.2,0) -- (0.4,0.15) (0.2,0) -- (0.4,-0.15);
			...
			% Draw EM rx
			\draw[shift = {(310:5.5)}, rotate = 130] (0,0.5) node{EM rx} (0,0) -- (0.2,0) -- (0.4,0.15) (0.2,0) -- (0.4,-0.15);
		\end{tikzpicture}
