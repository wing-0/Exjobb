...
# http://www.diabgroup.com/~/media/Files/Products/Core-material-products-
# English/H%20July%202018%20rev18%20SI.pdf
rho_0 = 60                  # Density
K = 70e6                    # Bulk modulus
mu = 20e6                   # Shear modulus
er = 1.06                   # Relative permittivity

# p-wave speed
v = np.sqrt((K+4*mu/3)/rho_0)
...
print(60*'-')
print('{0:>60s}'.format('ULTRASOUND AND MICROWAVES IN DIVINYCELL H60'))
print(60*'-')
