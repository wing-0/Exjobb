...
\begin{document}
	...
	\begin{frame}{Localized harmonic motion}{Generating localized harmonic motion}
		\resizebox{!}{0.8\textheight}{
			\begin{tikzpicture}
				% Blue beam
				\draw[shift={(2.5,0)},rotate={90+30}] (0,-0.15) rectangle (0.2,0.15) -- (0.4,0.3) -- (0.4,-0.3) -- (0.2,-0.15) (0,0) node[anchor=west]{$\Omega_0 - \Delta \Omega/2$};
				\fill[blue,shift={(2.5,0)},rotate=30,opacity=0.5] (-0.25,0.4) rectangle (0.25,10);
				
				% Red beam
				\draw[shift={(-2.5,0)},rotate={90-30}] (0,-0.15) rectangle (0.2,0.15) -- (0.4,0.3) -- (0.4,-0.3) -- (0.2,-0.15) (0,0) node[anchor=east]{$\Omega_0 - \Delta \Omega/2$};
				\fill[red,shift={(-2.5,0)},rotate=-30,opacity=0.5] (-0.25,0.4) rectangle (0.25,10);

				%\draw (0,0) -- (0,10) (-5,0) -- (5,0);
			\end{tikzpicture}
		}
	...
	\begin{frame}{Photoelastic interaction}{Angular dependence}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\textwidth]{Phi+-limitcase.eps}
				\end{figure}
			\end{column}
			\begin{column}{0.5\textwidth}
				\begin{figure}
	...
	\begin{frame}{Photoelastic interaction}{Angular dependence}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\textwidth]{Phi+-equal.eps}
				\end{figure}
			\end{column}
			\begin{column}{0.5\textwidth}
				\begin{figure}
	...
	\begin{frame}{Photoelastic interaction}{Geometry for maximum scattering - examples}
		...
		\begin{columns}
			\begin{column}{0.5\textwidth}
				\begin{figure}
					\centering
					\includegraphics[width=\textwidth]{scattergeom+.eps}
				\end{figure}
			\end{column}
			\begin{column}{0.5\textwidth}
				\begin{figure}
