...
%		\begin{itemize}
%			\item Lokaliserad vibration genom akustisk strålningskraft
%			\pause
%			\item Ultraljud amplitudmoduleras lokalt
%			\pause
%			\item Elektromagnetisk frekvens skiftas med vibrationsfrekvens
%		\end{itemize}
%	\end{frame}
